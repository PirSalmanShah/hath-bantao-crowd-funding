...
import { handlePayment } from '../actions/processPayment';
...
const CreditCardForm = () => {
 ...
 const [params, setParams] = useState({ name: "", amount: "", message: "" });
  ...
  useEffect(() => {
    ...
    const handleInputChange = (field, value, maxLength, formatter) => {
    ...
    const MastercardLogo = () => (
        <svg className="w-14 h-14" width="45" height="36" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-6 lg:p-24 ">
            {(status === "idle") && (<div className="bg-white/5 backdrop-blur-[10px] w-full max-w-3xl mx-auto px-4 lg:px-6 py-8 shadow-md rounded-md flex flex-col lg:flex-row">
                {/* Form Fields */}
                <div className="w-full lg:w-1/2 lg:pr-8 lg:border-r-2 lg:border-slate-300">
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            onChange={(e) => handleInputChange('cardNumber', e.target.value, 19, formatCardNumber)}
                        />
                    </div>
                    ...
                    <div className="flex gap-x-2 mb-4">
                        <div className="block flex-1">
                            ...
                            <input
                                ...
                                onChange={(e) => handleInputChange('expDate', e.target.value, 5, formatExpDate)}
                            />
                        </div>
                        <div className="block flex-1">
                            <label className="text-white font-bold text-sm mb-2 block">
                            ...
                            <input
                                ...
                                placeholder="123"
                                value={cardData.ccv}
                                onChange={(e) => handleInputChange('ccv', e.target.value, 3, formatCCV)}
                            />
                        </div>
                    </div>
                ...
                <div className="w-full lg:w-1/2 lg:pl-8">
                    <div className="w-full max-w-sm h-56" style={{ perspective: '1000px' }}>
                        <div
                            className={`relative cursor-pointer transition-transform duration-500 ${showBack ? 'rotate-y-180' : ''}`}
                        ...
                        >
                                ...
                                >
                                    <div className="w-full px-8 absolute top-8">
                                        ...
                                        <div className="pt-1">
                                            ...
                                            <p className="font-medium tracking-wider h-6 text-lg">
                                        ...
                                        <div className="pt-6 flex justify-between">
                                            ...
                                            <div>
                                                <p className="font-light text-sm">Expiry</p>
                                                <p className="font-medium tracking-wider h-6 w-14">
                                                    {cardData.expDate || 'MM/YY'}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {/* Back of Card */}
                            <div
                                className="w-full h-56 m-auto rounded-xl text-white shadow-2xl absolute rotate-y-180"
                                style={{ backfaceVisibility: 'hidden' }}
                            >
                                <div
                                    className="relative object-cover w-full h-full rounded-xl"
                                    ...
                                    <div className="w-full absolute top-8">
                                        ...
                                        <div className="px-8 mt-5">
                                            <div className="flex">
                                                ...
                                                <p className="bg-white text-black flex items-center pl-4 pr-2 w-14 text-sm font-medium">
                                                    {cardData.ccv || '123'}
                                                </p>
                                            </div>
